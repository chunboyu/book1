(function() {
	var h = {},
		mt = {},
		c = {
			id: "f4c77fe2523e4a5d8092ddefe64d971a",
			dm: ["zhibimo.com"],
	...
	(mt.s.wa = function() {
		...
		(function() {
			if (!e)
				if (e = q, "complete" === document.readyState) a.A = q;
				else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
				f, s), window.addEventListener("load", a, s);
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					g = mt.l.stringify;
					for (e in d)
						if (Object.prototype.hasOwnProperty.call(d, e)) switch (l =
							d[e], typeof l) {
							case "undefined":
							case "unknown":
							case "function":
	...
	(function() {
		...
		function e(a) {
			...
			if (a in t) l = a;
				...
				for (var n = ["webkit", "ms", "moz", "o"], b = 0; b < n.length; b++) {
			...
			g = {
				...
				ca: function() {
					...
					if (a && a.commands && a.commands[c.id])
						for (var b = a.commands[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, t = 0, n = b.length; t < n; t++) {
							var f = b[t];
							d.test(f[0]) ?
								g.q.push(f) : g.K(f)
						}
				...
				da: function() {
					if (0 < g.q.length)
						for (var a = 0, b = g.q.length; a < b; a++) g.K(g.q[a]);
					g.q = r
				},
				K: function(a) {
					var b = a[0];
				...
				v = function(b, d) {
					...
					if (a.e(d, "Array") || a.e(d, "NodeList"))
						for (var f = 0, e = d.length; f < e; f++)
							if (l === d[f]) return g(k + b + "/" + (f + 1), d[f]), s
				};
